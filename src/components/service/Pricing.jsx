      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-400 text-base md:text-lg mt-5 max-w-2xl mx-auto leading-relaxed">
            ...
            Clear, upfront pricing. Transparent domain & managed hosting.
          </p>
        </div>
                ...
                >
                  ...
                  <div className="mb-8 pb-8 border-b border-white/10">
                    ...
                    <p className="text-gray-500 text-[10px] uppercase tracking-widest mt-2 font-bold">
                      {plan.id === "fullpack" ? "Free 6 Months Managed Hosting" : "Free 1st Yr Domain & Server"}
                    </p>
                  </div>
                  ...
                  <div className="space-y-5 mb-8 flex-1">
                    {plan.featureGroups.map((group, groupIndex) => (
                      <div key={groupIndex}>
                        {/* Group Label */}
                        <p className="text-[9px] font-black uppercase tracking-[0.2em] text-gray-600 mb-2 border-b border-white/5 pb-1">
                          {group.groupLabel}
                        </p>
                        <ul className="space-y-2.5">
                          {group.features.map(({ icon: Icon, text, detail }, featureIndex) => {
                            const tooltipId = `${plan.id}-${groupIndex}-${featureIndex}`;
                              ...
                              <li key={text} className="flex items-start gap-3 group/feature">
                                ...
                                <div className="relative flex-1">
                                  <span
                                    ...
                                    className={`text-xs font-medium leading-snug transition-colors inline ${detail ? 'text-gray-300 hover:text-white cursor-pointer border-b border-dotted border-gray-600 md:cursor-help' : 'text-gray-400'}`}
                                  >
                                    {text}
                                  </span>
                                  {detail && (
                                    <div className={`absolute top-full left-0 mt-2 w-64 p-3 bg-[#1a1a1c] border border-white/10 rounded-xl shadow-xl z-50 md:bottom-full md:top-auto md:mt-0 md:mb-2 transition-all duration-200 ${isActive ? 'opacity-100 visible' : 'opacity-0 invisible md:group-hover/feature:opacity-100 md:group-hover/feature:visible'}`}>
                                      <p className="text-[11px] text-gray-300 leading-relaxed">{detail}</p>
