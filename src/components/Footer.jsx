...
export default function Footer() {
    ...
    return (
        <footer className="relative overflow-hidden bg-[#0a0a0c] border-t border-white/10">
            {/* ================= BACKGROUND - MATCHING TWOPILLARS DARK VIBE ================= */}
            <div
                ref={bgRef}
            ...
            >
                <Image
                    src="/footer.webp"
                    alt="Kyuverse Footer Background"
                    fill
                    quality={95}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a0a0c] via-[#0a0a0c]/80 to-transparent opacity-95" />
            </div>
            ...
            {/* Subtle Sparkles */}
            <div className="hidden sm:block absolute top-10 left-10 text-cyan-400/30 animate-pulse pointer-events-none">
                <Sparkles className="w-5 h-5" fill="currentColor" />
            </div>
            <div className="hidden sm:block absolute top-20 right-20 text-purple-400/30 animate-bounce pointer-events-none">
                <Sparkles className="w-4 h-4" fill="currentColor" />
            </div>

            {/* ================= CONTENT ================= */}
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-16 pb-16 sm:pb-20">
