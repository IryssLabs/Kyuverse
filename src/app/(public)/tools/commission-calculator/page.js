    ...
    <main className="min-h-screen bg-[#0a0a0c] text-white">
      ...
      <div className="border-b border-white/10 bg-[#0a0a0c]/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-3">
          ...
          {/* Right Header Controls (Currency dropdown removed from here) */}
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            <div className="flex items-center gap-1.5">
              <div className="relative flex h-1.5 w-1.5">
                ...
                <div
                  className={`relative inline-flex rounded-full w-1.5 h-1.5 ${loading ? "bg-gray-500 animate-pulse" : isLive ? "bg-green-400" : "bg-amber-400"
                    }`}
                />
              </div>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex gap-2 mb-6 sm:mb-8 border-b border-white/10 pb-0">
          {TABS.map((tab) => (
            <button
              ...
              className={`pb-3 px-1 text-xs sm:text-sm font-bold tracking-tight border-b-2 transition-all duration-200 ${activeTab === tab.id
        ...
        <div className="mt-10 sm:mt-12 text-center">
          <p className="text-[11px] text-gray-600">
            ...
            <a href="https://kyuverse.my.id" className="text-cyan-600 hover:text-cyan-400 transition-colors">
              Kyuverse
            </a>{" "}
